...
def ppo(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0, 
    ...
    x_ph, a_ph = core.placeholders_from_spaces(env.observation_space, env.action_space) #构建神经网络的时候，a_ph还没有
    adv_ph, ret_ph, logp_old_ph = core.placeholders(None, None, None)

    # Main outputs from computation graph
    pi, logp, logp_pi, v = actor_critic(x_ph, a_ph, **ac_kwargs) #目前这里的状态和action都还是放的placeholder
